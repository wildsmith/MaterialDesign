...
public class PresentationTitleRow extends PresentationListRow {
    ...
    public View getView(LayoutInflater inflater, View contentView, Context context, int position) {
        ...
        if (contentView == null) {
            contentView = inflater.inflate(R.layout.presentation_title_row, new LinearLayout(CoreMaterialApplication.getContext()), false);
            ...
            if (contentViewHolder instanceof ViewHolder == false) {
                contentView =
                        inflater.inflate(R.layout.presentation_title_row, new LinearLayout(CoreMaterialApplication.getContext()), false);
                holder = createViewHolder(contentView);
            } else {
