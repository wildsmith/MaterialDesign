...
public class PresentationNavigationRow extends PresentationListRow {
    ...
    public View getView(LayoutInflater inflater, View contentView, Context context, final int position) {
        ...
        if (contentView == null) {
            contentView =
                    inflater.inflate(R.layout.presentation_navigation_row, new LinearLayout(CoreMaterialApplication.getContext()), false);
            ...
            if (contentViewHolder instanceof ViewHolder == false) {
                contentView =
                        inflater.inflate(R.layout.presentation_navigation_row, new LinearLayout(CoreMaterialApplication.getContext()),
                                false);
                holder = createViewHolder(contentView);
            } else {
