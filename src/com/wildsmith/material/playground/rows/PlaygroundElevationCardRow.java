...
public class PlaygroundElevationCardRow extends PlaygroundCardListRow {
    ...
    public View getView(LayoutInflater inflater, View contentView, Context context, int position) {
        ...
        if (contentView == null) {
            contentView =
                    inflater.inflate(R.layout.playground_elevation_card_row, new LinearLayout(CoreMaterialApplication.getContext()), false);
            ...
            if (contentViewHolder instanceof ViewHolder == false) {
                contentView =
                        inflater.inflate(R.layout.playground_elevation_card_row, new LinearLayout(CoreMaterialApplication.getContext()),
                                false);
                holder = createViewHolder(contentView, position);
            } else {
